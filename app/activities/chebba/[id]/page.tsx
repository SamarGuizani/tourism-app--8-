...
export default async function ChebbaActivityDetailPage({ params }: { params: { id: string } }) {
  const supabase = createServerComponentClient({ cookies })

  const { data: activity, error } = await supabase.from("activities_chebba").select("*").eq("id", params.id).single()
